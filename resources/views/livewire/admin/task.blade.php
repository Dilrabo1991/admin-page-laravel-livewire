<div>
  ...
  <div class="container ">
    <div class="card-my-4">
        ...
        <h3>Tasks list</h3>
        <botton data-toggle="modal" data-target="#addTasks"
         class="btn btn-secondary">Tasks</botton>
        </div>
    </div>
    <div class="card-body">
            ...
            <table class="table">
                ...
                <tbody>
                     <tr>
                        ...
                        <td>pending</td>
                        <td>Dilrabo</td>
                       <td><botton  data-toggle="modal" data-target="#updateTasks" class="btn btn-success"><td>
...
<!--add Tesk Modal -->
<div class="modal fade" id="addTasks" tabindex="-1" role="dialog" 
      ...
      <form action="">
        <div class="modal-body">
          ...
          <div class="form-group">
              ...
              <select name="" id="" class="form-control">
                  <option value="">Dilrabo Doniyorovna</option>
...
<div class="modal fade" id="updateTasks" tabindex="-1" role="dialog"  aria-labelledby="exampleModalLabel" 
 aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update Tesks</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>  
