<div>
  ...
  <div class="container ">
    <div class="card-my-4">
        ...
        <h3> User list</h3>
        <botton data-toggle="modal" data-target="#addUser"
         class="btn btn-secondary"> User </botton>
        </div>
    </div>
    <div class="card-body">
            ...
            <table class="table">
                ...
                <tbody>
                     <tr>
                        <td>2</td>
                        <td>Dilrabo</td>
                        <td>dilraboxujamuratova@gmail.com</td>
                        <td>7777777</td>
                       <td><botton  data-toggle="modal" data-target="#updateUser" class="btn btn-success"><td>
